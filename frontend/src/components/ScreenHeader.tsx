...
const ScreenHeader = ({ onBack, title, icon, subtitle }: ScreenHeaderProps) => (
  <div className="sticky top-0 z-30 bg-background/90 backdrop-blur-md border-b border-border/50">
    <div className="flex items-center gap-3 px-5 py-4">
      <button
        onClick={onBack}
        className="w-10 h-10 rounded-none bg-card border border-border flex items-center justify-center active:scale-95 transition-all text-foreground hover:bg-muted"
      >
