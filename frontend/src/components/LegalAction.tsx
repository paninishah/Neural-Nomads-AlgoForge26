...
export default function LegalAction({ onBack, lang }: { onBack: () => void; lang: Lang }) {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#f8faf8] via-[#eef4ea] to-[#e6f0e2] pb-32">
      <ScreenHeader onBack={onBack} title="Legal Companion" icon="⚖️" subtitle="Smart analysis & guidance" />
      
      {/* Background Glows */}
      <div className="fixed inset-0 pointer-events-none -z-10">
        <div className="absolute top-10 left-[-50px] w-64 h-64 bg-green-200/50 rounded-full blur-3xl opacity-60" />
        <div className="absolute top-[40%] right-[-50px] w-64 h-64 bg-yellow-200/50 rounded-full blur-3xl opacity-60" />
      </div>
        ...
        <AnimatePresence mode="wait">
          ...
          {step === 'input' && (
            <motion.div key="input" initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="space-y-6">
              ...
              <div className="relative group">
                <div className="absolute -inset-1 bg-gradient-to-r from-green-300 to-yellow-200 rounded-3xl blur opacity-30 group-focus-within:opacity-60 transition duration-500" />
                <div className="relative bg-white/80 backdrop-blur-xl border border-white/60 p-4 rounded-3xl shadow-sm">
                  <textarea 
                    value={inputText}
                  ...
                  <div className="flex justify-between items-center mt-2 pt-3 border-t border-gray-100">
                    <div className="flex gap-2">
                      <button className="w-10 h-10 rounded-full bg-gray-50 flex items-center justify-center text-gray-400 hover:text-green-600 hover:bg-green-50 active:scale-95 transition-all">
                        <Paperclip className="w-5 h-5" />
                      </button>
                      <button className="w-10 h-10 rounded-full bg-green-100 flex items-center justify-center text-green-700 hover:bg-green-200 active:scale-95 transition-all shadow-[0_0_15px_rgba(34,197,94,0.3)]">
                    ...
                    <button 
                      ...
                      disabled={!inputText}
                      className="bg-green-600 text-white px-5 py-2.5 rounded-full font-bold text-sm tracking-wide flex items-center gap-2 active:scale-95 transition-all disabled:opacity-50 disabled:active:scale-100"
                    >
              ...
              <div className="bg-blue-50/50 backdrop-blur-sm border border-blue-100 rounded-2xl p-4 flex gap-3 text-blue-800">
            ...
            <motion.div key="analyzing" initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }} className="flex flex-col items-center justify-center py-20">
              ...
              {step === 'analyzing' && (
                <motion.div className="flex flex-col items-center">
                  <motion.div animate={{ scale: [1, 1.2, 1], rotate: [0, 180, 360] }} transition={{ duration: 3, repeat: Infinity, ease: "linear" }} className="w-20 h-20 rounded-full bg-gradient-to-tr from-green-400 to-yellow-300 p-1 flex items-center justify-center shadow-2xl shadow-green-400/30">
              ...
              {/* Reveal Card */}
              {step === 'detected' && (
                <motion.div initial={{ opacity: 0, y: 30, scale: 0.95 }} animate={{ opacity: 1, y: 0, scale: 1 }} className="w-full bg-white rounded-[2rem] p-6 shadow-2xl border border-green-100 relative overflow-hidden">
                  ...
                  <div className="bg-gray-50 rounded-2xl p-4 border border-gray-100 space-y-3">
                    ...
                    <div className="flex justify-between items-center text-sm font-hind border-b border-gray-200 pb-2">
                      ...
                      <span className="font-bold text-red-600 bg-red-50 px-2 py-0.5 rounded-md">₹14,500</span>
                    </div>
                  ...
                  <div className="flex gap-3 mt-6">
                    <button onClick={() => setStep('input')} className="flex-1 py-3.5 rounded-xl font-bold font-mukta text-gray-600 bg-gray-100 active:scale-95 transition-transform">
                      Change Text
                    </button>
                    <button onClick={() => setStep('dashboard')} className="flex-1 py-3.5 rounded-xl font-bold font-mukta text-white bg-green-600 shadow-lg shadow-green-600/30 active:scale-95 transition-transform flex justify-center items-center gap-2">
          ...
          {step === 'dashboard' && (
            <motion.div key="dashboard" initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0 }} className="space-y-6 pb-20">
              ...
              <div className="bg-white rounded-3xl p-5 shadow-sm border border-gray-100 bg-gradient-to-br from-white to-green-50/30">
              ...
              <div className="bg-white rounded-3xl p-5 shadow-sm border border-gray-100">
                ...
                <div className="h-4 w-full bg-gray-100 rounded-full overflow-hidden mb-4 relative drop-shadow-inner border border-gray-200">
                  <motion.div initial={{ width: 0 }} animate={{ width: "72%" }} transition={{ duration: 1.5, ease: "easeOut" }} className="absolute h-full bg-gradient-to-r from-red-500 via-yellow-400 to-green-500 rounded-full" />
                </div>
              ...
              <div className="grid grid-cols-2 gap-3">
                <div className="bg-gradient-to-br from-green-500 to-green-600 rounded-3xl p-4 text-white shadow-lg shadow-green-500/20">
                ...
                <div className="bg-gradient-to-br from-gray-800 to-gray-900 rounded-3xl p-4 text-white shadow-lg shadow-black/10">
              ...
              <div className="bg-yellow-50/50 border border-yellow-200 rounded-3xl p-5 relative overflow-hidden">
                ...
                <div className="space-y-4">
                   <div className="flex gap-3">
                     <div className="w-6 h-6 rounded-full bg-yellow-200 text-yellow-800 font-bold font-mukta flex items-center justify-center flex-shrink-0 text-xs">1</div>
                   ...
                   <div className="flex gap-3">
                     <div className="w-6 h-6 rounded-full bg-yellow-200 text-yellow-800 font-bold font-mukta flex items-center justify-center flex-shrink-0 text-xs">2</div>
                     <p className="font-hind text-sm text-gray-700">Do not throw away the remaining pesticide bottles as evidence.</p>
                   </div>
                </div>

                <motion.div animate={{ opacity: [0.8, 1, 0.8] }} transition={{ duration: 2, repeat: Infinity }} className="mt-5 bg-red-50/80 border border-red-100 rounded-xl p-3 flex gap-3 shadow-inner">
              ...
              <div className="bg-white rounded-3xl overflow-hidden shadow-sm border border-gray-200">
                <div className="bg-gray-50 px-5 py-3 border-b border-gray-200 flex justify-between items-center">
                  ...
                  <span className="bg-blue-100 text-blue-700 font-bold text-[10px] px-2 py-0.5 rounded-md uppercase tracking-wider">Editable</span>
                </div>
              ...
              <div className="bg-gradient-to-br from-gray-900 to-black rounded-3xl p-5 text-white relative overflow-hidden group hover:shadow-2xl hover:shadow-green-500/20 transition-all cursor-pointer">
                {/* Visual Hotspot Glow */}
                <div className="absolute top-[-30px] right-[-30px] w-24 h-24 bg-red-500 rounded-full blur-2xl opacity-60 group-hover:opacity-100 group-hover:scale-125 transition-all duration-700" />
                <div className="absolute bottom-[-20px] left-[-20px] w-20 h-20 bg-orange-500 rounded-full blur-2xl opacity-40" />
              ...
              <div className="bg-white rounded-3xl p-5 shadow-sm border border-gray-100">
                ...
                <div className="space-y-3">
                  <div className="flex justify-between items-center p-3 rounded-2xl bg-gray-50 border border-gray-100 hover:border-green-200 cursor-pointer transition-colors group">
                  ...
                  <div className="flex justify-between items-center p-3 rounded-2xl bg-gray-50 border border-gray-100 hover:border-blue-200 cursor-pointer transition-colors group">
                    <div className="flex gap-3 items-center">
                      <div className="w-10 h-10 rounded-xl bg-white flex items-center justify-center shadow-sm">
              ...
              <div className="pt-2 flex flex-col gap-3">
                <button 
                  ...
                  className="w-full bg-gradient-to-r from-green-600 to-green-500 text-white rounded-2xl py-4 font-bold font-mukta text-lg shadow-xl shadow-green-600/30 flex justify-center items-center gap-2 hover:bg-green-700 active:scale-95 transition-all"
                >
                  🚀 Submit Complaint Instantly
                </button>
                <div className="flex gap-3">
                  <button className="flex-1 bg-white border border-gray-200 text-gray-700 rounded-2xl py-3 font-bold font-mukta flex justify-center items-center gap-2 hover:bg-gray-50 active:scale-95 transition-all">
          ...
          {step === 'submitted' && (
            <motion.div key="submitted" initial={{ opacity: 0, scale: 0.95 }} animate={{ opacity: 1, scale: 1 }} className="flex flex-col items-center justify-center py-10 mt-6 relative">
               ...
               <div className="absolute inset-0 pointer-events-none overflow-hidden">
                 {[...Array(6)].map((_, i) => (
                   <motion.div key={`confetti-${i}`} initial={{ y: 200, opacity: 0, rotate: 0 }} animate={{ y: -500, opacity: [0, 1, 0], rotate: 360 }} transition={{ duration: 2.5 + Math.random() * 2, delay: i * 0.2 }} className="absolute w-3 h-3 rounded-sm bg-green-400" style={{ left: `${20 + i * 15}%` }} />
                 ))}
               </div>

               <div className="w-24 h-24 bg-green-100 rounded-full flex items-center justify-center mb-6 shadow-[0_0_50px_rgba(34,197,94,0.4)] relative">
               ...
               <p className="font-hind text-gray-500 bg-gray-100 px-4 py-1.5 rounded-full font-bold text-sm">Ref No: KS-2025-0847</p>

               {/* Step Tracker (Process Feel) */}
               <div className="w-full bg-white rounded-3xl p-6 shadow-sm border border-gray-100 mt-8 relative">
                  <div className="absolute top-10 left-[48px] w-0.5 h-[calc(100%-80px)] bg-gray-100 -z-10" />

                  <div className="space-y-6">
                    {/* Step 1 */}
                    <div className="flex gap-4">
                      <div className="w-10 h-10 rounded-full bg-green-500 text-white flex items-center justify-center flex-shrink-0 z-10 shadow-md">
                    ...
                    <div className="flex gap-4 opacity-50">
                      <div className="w-10 h-10 rounded-full bg-white border-2 border-gray-200 text-gray-400 flex items-center justify-center flex-shrink-0 z-10 box-border">
               ...
               <div className="mt-8 text-center bg-blue-50 border border-blue-100 rounded-2xl p-4 w-full flex items-center gap-3">
                 <div className="w-8 h-8 rounded-full bg-blue-100 flex items-center justify-center flex-shrink-0"><span className="text-sm">🔔</span></div>
